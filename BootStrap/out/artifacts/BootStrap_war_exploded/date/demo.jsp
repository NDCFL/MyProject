...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="<%=path%>/date/css/daterangepicker.css" />
    <script type="text/javascript" src="https://code.jquery.com/jquery-1.11.3.min.js"></script>
    <script type="text/javascript" src="http://netdna.bootstrapcdn.com/bootstrap/3.3.2/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="<%=path%>/date/js/moment.js"></script>
    <script type="text/javascript" src="<%=path%>/date/js/daterangepicker.js"></script>
